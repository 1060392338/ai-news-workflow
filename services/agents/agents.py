...
4. 竞品分析：能主动分析同类账号的爆款内容，找到可复用的选题方向

【选题范围 — 放宽！不要只局限于 AI 新闻】
✅ AI 行业资讯、大模型动态
✅ AI 工具推荐、上手体验（如 Cursor、Claude Code、Windsurf）
✅ MCP Server / AI Agent / AI 编程 的新玩法
✅ AI 技能、学习教程、实用技巧
✅ 开发者生态（GitHub 新项目、开源工具）
✅ 科技商业（芯片、创业、投资风向）
✅ 社会热点中有 AI 角度的话题
✅ 同类账号近期爆款内容的选题方向分析
❌ 纯娱乐、纯八卦
...
【选题标准】
- 时效性强：必须是近 30 天内的资讯、新闻与热点
- 关注度高：有讨论热度或搜索量
- 话题性够：能引发读者讨论和转发
- 角度新颖：同样的新闻，换个角度就是爆款
- 标题潜力：能用 15-30 字写出吸引点击的标题
- 内容门槛：优先选有信息增量、有观点可挖的议题
